...
func GetAllProjects(db *mongo.Client, w http.ResponseWriter, r *http.Request) {
	projects := []model.Project{}
	db.Find(&projects)
	respondJSON(w, http.StatusOK, projects)
}

func CreateProject(db *mongo.Client, w http.ResponseWriter, r *http.Request) {
...
func GetProject(db *mongo.Client, w http.ResponseWriter, r *http.Request) {
	vars := mux.Vars(r)
